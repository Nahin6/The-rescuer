        ...
        <div class="container-fluid position-relative d-flex p-0">
            ...
            <div class="sidebar pe-4 pb-3">
                <nav class="navbar bg-secondary navbar-dark">
                    <a href="admin/index.html" class="navbar-brand mx-4 mb-3">
                    ...
                    <div class="navbar-nav w-100">
                        ...
                        <div class="nav-item dropdown">
                            <a href="{{ url('/redirects') }}" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>Elements</a>
                            <div class="dropdown-menu bg-transparent border-0">
                                <a href="{{ url('/redirects') }}" class="dropdown-item">Buttons</a>
            ...
            <div class="content">
               ...
               @include('admin.AdminNavbar')
                ...
                <!-- Sale & Revenue Start -->
                @include('admin.AdminSaleRevenue')
                <!-- Sale & Revenue End -->


                <!-- Sales Chart Start -->
                @include('admin.AdminSaleChart')
                <!-- Sales Chart End -->


                <!-- Recent Sales Start -->
               @include('admin.AdminRecentSaleStart')
                <!-- Recent Sales End -->


                <!-- Widgets Start -->
                @include('admin.AdminWidgets')
                <!-- Widgets End -->
